...
public interface DirectorySvcApi {
	...
	public Collection<Directory> getDirectories(Long id, String name, Double lat, Double lon, Double alt, Double azi,
			String ver, String plat, String dkey);

	@GET(DIRECTORY_CREATE_PATH)
	public String createDirectory(String name);

	@GET(DIRECTORY_UPDATE_PATH)
	public String updateDirectory(Long id, Double lat, Double lon, Double alt, Double azi, String ver, String plat,
			String dkey);
